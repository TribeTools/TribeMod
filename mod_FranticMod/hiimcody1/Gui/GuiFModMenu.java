...
public class GuiFModMenu extends GuiScreen
{
	...
	public void initGui()
    {
        ...
        controlList.add(new GuiButton(4, width / 2 - 100, height / 4 + 24 + byte0, 98, 20, "Lookup"));
        ...
        controlList.add(new GuiButton(7, width / 2 - 100, height / 4 + 96+24 + byte0, "Connect to IRC"));
        
        controlList.add(new GuiButton(8, width / 2 + 2, height / 4 + 24 + byte0, 98, 20, "BanHistory"));
        
        GuiTools.getButtonByDisplayString(controlList, "Report Ban").enabled = false;
    ...
    protected void actionPerformed(GuiButton guibutton)
    {
        ...
        if(guibutton.id == 4)
        {
        	mc.displayGuiScreen(new GuiUserSearch());
        }
        if(guibutton.id == 5)
        { 
        ...
        if(guibutton.id == 8)
        {
        	mc.displayGuiScreen(new GuiUserHistory());
        }
    }
